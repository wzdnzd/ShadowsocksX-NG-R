...
let NOTIFY_TIME_INTERAVAL_DELAY_CHANGED = Notification.Name(rawValue: "NOTIFY_TIME_INTERAVAL_DELAY_CHANGED")
let NOTIFY_TIME_INTERAVAL_SUBSCRIBE_CHANGED = Notification.Name(rawValue: "NOTIFY_TIME_INTERAVAL_SUBSCRIBE_CHANGED")
