...
static NSString * const USERDEFAULTS_ENABLE_SHOW_SPEED = @"EnableShowSpeed";
...
static NSString * const USERDEFAULTS_AUTO_DELAY_TEST = @"AutoDelayTest";
static NSString * const USERDEFAULTS_TIME_INTERAVAL_DALAY_TEST_ENABLE = @"TimeInteraval.DelayTestEnable";
